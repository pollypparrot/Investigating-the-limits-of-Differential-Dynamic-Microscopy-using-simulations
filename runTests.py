...
print("startSim")
simulationCode.coordinateSimulatorMultiple("Run and Tumble",frameRate,videoTitle,particleSize,xFrameLength,yFrameLength,zCutOff,fileNames,numStepsAnalysed,maxPixelStack)
